  ...
  $.fn.verticalTimeline = function(options) {
    ...
    return this.each(function() {
      ...
      if (!settings.alternate) {
        $(this)
          .find(".vtimeline-block")
          .addClass("vtimeline-" + settings.startSide);
      } else {
        if (settings.startLeft) {
          $(this)
            .find(".vtimeline-point:odd")
            .each(function() {
              $(this)
                .find(".vtimeline-block")
                .addClass("vtimeline-right");
            });
        } else {
          $(this)
            .find(".vtimeline-point:even")
            .each(function() {
              $(this)
                .find(".vtimeline-block")
                .addClass("vtimeline-right");
      ...
      $(this)
        ...
        .each(function() {
          ...
          if (side) {
            $(this)
              .parent()
              .removeClass("vtimeline-right");
            $(this)
              .parent()
              .addClass("vtimeline-" + side);
          }
        });
